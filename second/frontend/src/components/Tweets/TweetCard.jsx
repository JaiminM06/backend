...
export default function TweetCard({ tweet, currentUserId, onRetweet, onReply, onQuote }) {
  ...
  const handleRetweetClick = async (e) => {
    ...
    setLocalRetweetCount(originalRetweeted ? Math.max(0, originalRetweetCount - 1) : originalRetweetCount + 1);
